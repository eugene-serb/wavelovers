...
export const useGamepadsStore = defineStore('gamepads', () => {
   ...
   * Временная метка.
   *
   * Нужна для обновления состояния геймпадов, т.к. сами они это не делают.
   */
   ...
   *
   * Запускает слушатели событий для добавления и удаления геймпадов,
   ...
   *
   * Удаляет слушатели событий для добавления и удаления геймпадов,
   * а также, их обновления.
   */
