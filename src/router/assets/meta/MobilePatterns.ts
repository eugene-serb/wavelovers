...
export const metaMobilePatterns: IMeta = {
  title: 'Wavelovers — Mobile Patterns',
  metaTags: [
    {
      name: 'keywords',
      content:
    ...
    },
    {
      name: 'description',
      content:
        'Wavelovers mobile pattern mode. Wavelovers is a vibration test tool for gamepads and mobile devices that can also turn them into vibration massagers. It has free vibration templates, template editor and manual control mode.',
    },
    {
      name: 'og:title',
      content: 'Wavelovers — Mobile Patterns',
    },
    {
      name: 'og:description',
      content:
...
export default metaMobilePatterns;
